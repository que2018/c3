...
class Sale_total extends MX_Controller 
{
	public function index()
	{
		...
		$this->load->model('sale_total_model');
		...
		$sale_total = $this->sale_total_model->get_period_sale_total($filter_data);
		...
		$sale_total_last_month = $this->sale_total_model->get_period_sale_total($filter_data);
