...
<link href="<?php echo base_url(); ?>assets/css/font-awesome/css/font-awesome.css" type="text/css" rel="stylesheet" />
		...
		<ul class="nav metismenu" id="side-menu">
		  <li class="nav-header">
			<div class="dropdown profile-element">
			  <span><img alt="image" class="img-circle" src="<?php echo $logo; ?>" /></span>
			</div>
		  </li>
		  <li>
		  ...
		  <li>
			...
			<ul class="nav nav-second-level">
			  ...
			  <li><a href="<?php echo base_url(); ?>check/checkout_group"><?php echo $this->lang->line('menu_checkout_group'); ?></a></li>
      ...
      <div class="row border-bottom">
        <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
          ...
          <ul class="nav navbar-top-links navbar-right">
			<li>
			  <span class="m-r-sm text-muted welcome-message"><?php echo $username; ?></span>
			</li>
