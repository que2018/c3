...
$lang['text_store_sale_sync_list_description']  	   = '显示 all the 店铺 订单 sync';
...
$lang['error_store_sale_product_sku_not_set']          = '<a target="_blank" href="%s"><strong>订单 #%s</strong> has 产品 <strong>#%s</strong> that the sku 是 未设置</a>';
