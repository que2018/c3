...
$lang['text_location_add_success'] 	      = '<i 单位="fa fa-check-circle-o"></i>&nbsp;库位 添加 成功';
$lang['text_import_location_description'] = '导入 库位 form excel 文件';
$lang['text_location_list_description']   = '显示 所有 库位';
$lang['text_location_edit_success'] 	  = '<i 单位="fa fa-check-circle-o"></i>&nbsp;库位 编辑 成功';
$lang['text_location_delete_success'] 	  = '<i 单位="fa fa-check-circle-o"></i>&nbsp;库位 删除 成功';
$lang['text_confirm_delete']              = '您确定要 删除 这个 库位?';
