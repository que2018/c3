...
$lang['text_delete'] 	  	             				= 'delete product';
$lang['text_save'] 	  	             					= 'save product';
$lang['text_cancel'] 	  	             				= 'cancel';
$lang['text_bulk_delete'] 	  	            			= 'bulk delete';
$lang['text_export'] 	  	             				= 'export product';
...
$lang['text_confirm_delete'] 	 	  	        		= 'Are you sure to delete this product?';
$lang['text_confirm_bulk_delete'] 	 	  	    		= 'Are you sure to delete selected product?';
...
$lang['error_price_positive_number']            		= 'price must be an positive number';
$lang['error_length_positive_number']           		= 'length must be an positive number';
$lang['error_width_positive_number']            		= 'width must be an positive number';
$lang['error_height_positive_number']           		= 'height must be an positive number';
$lang['error_weight_positive_number']           		= 'weight must be an positive number';
...
$lang['error_product_can_not_delete_transfer_exist']    = '<i class="fa fa-exclamation-triangle"></i>&nbsp;%s can not be deleted because the transfer exists';
$lang['error_product_can_not_delete_inventory_exist']   = '<i class="fa fa-exclamation-triangle"></i>&nbsp;%s can not be deleted because the inventory exists';
