...
$lang['text_sale_add_success']		            = '<i 单位="fa fa-check-circle-o"></i>&nbsp;sale添加成功';
$lang['text_sale_edit_success']		            = '<i 单位="fa fa-check-circle-o"></i>&nbsp;sale编辑成功';
$lang['text_import_order_success'] 	  	 		= '<i 单位="fa fa-check-circle-o"></i>&nbsp;sale成功导入';
...
$lang['error_order_exist'] 	  	         		= '<i 单位="fa fa-exclamation-triangle"></i>&nbsp;店铺saleID<strong>%s</strong>是存在';
