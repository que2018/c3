...
$lang['text_order_detail'] 	  	                = '订单详情';
$lang['text_all_orders'] 	  	                = '所有订单';
$lang['text_unsolved_order'] 	  	            = '未处理的订单';
$lang['text_sale_add'] 	  	                	= '添加订单';
$lang['text_sale_edit'] 	  	               	= '编辑订单';
$lang['text_store_sale_id'] 	  	            = '店铺订单ID';
...
$lang['text_sale_product'] 	  	            	= '订单产品';
$lang['text_sale_fee'] 	  	            		= '订单费';
...
$lang['text_unsolved_order_list'] 	  	        = '未处理的订单列表';
$lang['text_import_order'] 	  	         		= '导入订单';
...
$lang['text_checkout_order_note'] 	  	        = '出库订单 #%s';
$lang['text_download_sample_file'] 	  	        = '下载模板文件';
$lang['text_order_list_description'] 	 		= '显示所有订单';
$lang['text_unsolved_order_list_description']  	= '显示所有未处理订单';
$lang['text_only_excel_will_accepted'] 	 		= '( 只有Excel文件才能被接受 )';
$lang['text_import_order_description'] 	 		= '从Excel文件导入订单';
$lang['text_drop_file_and_upload'] 	     		= '拖入文件或者点击上传';
$lang['text_confirm_delete'] 	  	     		= '您确定要删除这个订单?';
$lang['text_label_fee_note1']    	            = '订单标签费 - ID: %s 店铺订单ID: %s';
$lang['text_label_fee_note2']    	            = '订单标签费 - ID: %s';
$lang['text_sale_transaction_note']    	        = '订单交易费用 - ID: %s';
$lang['text_sale_add_success']		            = '<i 单位="fa fa-check-circle-o"></i>&nbsp;订单添加成功';
$lang['text_sale_edit_success']		            = '<i 单位="fa fa-check-circle-o"></i>&nbsp;订单编辑成功';
$lang['text_import_order_success'] 	  	 		= '<i 单位="fa fa-check-circle-o"></i>&nbsp;订单成功导入';
$lang['text_checkout_record_is_generated']		= '<i 单位="fa fa-check-circle-o"></i>&nbsp;出库记录是生成';
$lang['text_success_rows_imported'] 	  	    = '<i 单位="fa fa-check-circle-o"></i>&nbsp;<strong>%s行被导入</strong>';
$lang['text_error_rows_imported'] 	  	    	= '<i 单位="fa fa-exclamation-triangle"></i>&nbsp;<strong>%s行被导入</strong>';
...
$lang['column_store_order_id'] 	  	     		= '店铺订单Id';
...
$lang['error_order_exist'] 	  	         		= '<i 单位="fa fa-exclamation-triangle"></i>&nbsp;店铺订单ID<strong>%s</strong>是存在';
$lang['error_client_not_select'] 	  	 		= '<i 单位="fa fa-exclamation-triangle"></i>&nbsp;客户未选择的';
$lang['error_row_data'] 	  	         		= '<i 单位="fa fa-exclamation-triangle"></i>&nbsp;<strong>%sth</strong>行有无效数据';
...
$lang['error_client_product_not_found']  		= '<i 单位="fa fa-exclamation-triangle"></i>&nbsp;这个产品没有找到';
