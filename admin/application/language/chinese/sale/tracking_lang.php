...
$lang['text_order_list_description'] 	 		= '显示 所有未处理订单';
$lang['text_unsolved_order_list_description']  	= '显示 所有订单';
...
$lang['text_checkout_record_is_generated']		= '<i 单位="fa fa-check-circle-o"></i>&nbsp;出库 记录 是 生成';
$lang['text_success_rows_imported'] 	  	    = '<i 单位="fa fa-check-circle-o"></i>&nbsp;<strong>%s 行 被导入</strong>';
$lang['text_error_rows_imported'] 	  	    	= '<i 单位="fa fa-exclamation-triangle"></i>&nbsp;<strong>%s 行 被导入</strong>';
...
$lang['error_sku_client_error'] 	  	        = '<i 单位="fa fa-exclamation-triangle"></i>&nbsp;第%s行: sku <strong>%s</strong> 是 not belong to the owner of the 店铺';
...
$lang['error_row_data'] 	  	         		= '<i 单位="fa fa-exclamation-triangle"></i>&nbsp;the <strong>%sth</strong> row has 无效数据';
...
$lang['error_tracking_is_used']                 = '<i 单位="fa fa-exclamation-triangle"></i>&nbsp;The 追踪号 number <strong>%s</strong> 已被使用';
$lang['error_client_product_not_found']  		= '<i 单位="fa fa-exclamation-triangle"></i>&nbsp;the 产品 of 这个 客户 是 没有找到';
