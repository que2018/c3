...
$lang['text_offline_sync_tracking_success']  = '<i class="fa fa-check-circle-o"></i>&nbsp;The 追踪号 for order <strong>%s</strong> sync 成功';
...
$lang['error_offline_sync_tracking_error']   = '<i class="fa fa-exclamation-triangle"></i>&nbsp;追踪号 sync for order <strong>%s</strong> 是 fail: <strong>%s</strong>';
