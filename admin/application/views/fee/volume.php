<link href="<?php echo base_url(); ?>assets/css/app/fee/volume.css" rel="stylesheet"> 
		    ...
		    <div id="general" class="tab-pane active">
			  <div class="panel-body">
			     <div class="form-group">
			      ...
			      <div class="col-sm-10"><input name="volume_amount" value="<?php echo $volume_amount; ?>" class="form-control"></div>
				</div>
