<link href="<?php echo base_url(); ?>assets/css/app/store/employee_add.css" rel="stylesheet"> 
<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-lg-12">
	<h2><?php echo $this->lang->line('text_add_employee'); ?></h2>
	<ol class="breadcrumb">
	  ...
	  <li class="active"><strong><?php echo $this->lang->line('text_add_employee'); ?></strong></li>
	</ol>
  </div>
...
<div class="wrapper wrapper-content animated fadeInRight">
  <div class="row">
    ...
    <?php } ?>
    <form method="post" action="<?php echo base_url(); ?>store/employee/add" class="form-horizontal">
