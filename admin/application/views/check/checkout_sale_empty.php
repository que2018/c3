...
<div class="row wrapper border-bottom white-bg page-heading">
  ...
  <div class="button-group tooltip-demo">
	<button data-toggle="tooltip" data-placement="top" title="<?php echo $this->lang->line('text_generate_checkout'); ?>" class="btn btn-primary btn-generate" onclick="submit()"><i class="fa fa-play"></i></button>
  </div>
</div>
