					...
					<tr>
					  ...
					  <td>
						...
						<div class="detail" style="top: <?php echo $offset * 50 + 170; ?>px;">
						  <table class="table">
						    <thead>
							  <th style="width: 28%;"><?php echo $this->lang->line('column_name'); ?></th>
							  <th style="width: 18%;"><?php echo $this->lang->line('column_type'); ?></th>
							  <th style="width: 18%;"><?php echo $this->lang->line('column_loc'); ?></th>
							  <th style="width: 18%;"><?php echo $this->lang->line('column_batch'); ?></th>
							...
							<tbody>
							  ...
							  <tr>
								...
								<td>
								<?php if($checkout_product['type']) { ?>
								<span class="return"><?php echo $this->lang->line('text_return'); ?></span>
								<?php } else { ?>
								<span class="inventory"><?php echo $this->lang->line('text_inventory'); ?></span>
								<?php } ?>
								</td>
