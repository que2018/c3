...
<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-lg-12">
	<h2><?php echo $this->lang->line('text_user_add'); ?></h2>
	<ol class="breadcrumb">
	  <li><a href="<?php echo base_url(); ?>"><?php echo $this->lang->line('text_home'); ?></a></li>
	  <li><a href="<?php echo base_url(); ?>user/user"><?php echo $this->lang->line('text_user'); ?></a></li>
	  <li class="active"><strong><?php echo $this->lang->line('text_user_add'); ?></strong></li>
	</ol>
  ...
  <div class="row">
	...
	<div class="ibox">
	  <div class="ibox-content">
		<form method="post" action="<?php echo base_url(); ?>user/user/add" class="form-horizontal">
