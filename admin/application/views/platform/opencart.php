<link href="<?php echo base_url(); ?>assets/css/app/platform/opencart.css" rel="stylesheet"> 
<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-lg-12">
	<h2><?php echo $this->lang->line('text_opencart'); ?></h2>
	<ol class="breadcrumb">
	  <li><a href="<?php echo base_url(); ?>"><?php echo $this->lang->line('text_home'); ?></a></li>
	  <li><a href="<?php echo base_url(); ?>extension/platform"><?php echo $this->lang->line('text_platform'); ?></a></li>
	  <li class="active"><strong><?php echo $this->lang->line('text_opencart'); ?></strong></li>
	</ol>
  </div>
		  ...
		  <div class="tab-content">
		    <div id="fields" class="tab-pane active">
			  <div class="panel-body">
			    <?php foreach($opencart_fields as $opencart_field) { ?>
			      <div class="form-group">
				    <label class="col-sm-2 control-label"><?php echo $this->lang->line('entry_field'); ?></label>
			        <div class="col-sm-10"><input name="opencart_field[]" value="<?php echo $opencart_field; ?>" class="form-control" readonly></div>
				  </div>
		    ...
		    <div id="setting" class="tab-pane">
			  <div class="panel-body">
			    <div class="form-group">
				  ...
				  <div class="col-sm-10">
				    <select name="opencart_status" class="form-control">
					  <?php if($opencart_status) { ?>
                ...
                <div class="form-group">
				  ...
				  <div class="col-sm-10"><input name="opencart_sort_order" value="<?php echo $opencart_sort_order; ?>" class="form-control"></div>	  
			    </div>
                <div class="hr-line-dashed"></div>				
			  </div>
		    </div>
