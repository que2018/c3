...
<link href="<?php echo base_url(); ?>assets/css/app/sale/sale_edit.css" rel="stylesheet"> 
...
<div class="row wrapper border-bottom white-bg page-heading">
  ...
  <div class="button-group tooltip-demo">
    ...
    <a href="<?php echo base_url(); ?>check/checkout_sale?sale_id=<?php echo $sale_id; ?>" data-toggle="tooltip" data-placement="top" title="<?php echo $this->lang->line('text_generate_packing_list'); ?>" class="btn btn-gen"><i class="fa fa-refresh"></i></a>
		  ...
		  <div id="general" class="tab-pane active">
			<div class="panel-body">
			  ...
			  <div class="form-group">
                ...
                <div class="col-sm-10">
				  <div class="input-group">
				    <span id="btn-sync" class="input-group-addon"><i class="fa fa-refresh"></i></span>
				    <input type="text" name="tracking" value="<?php echo $tracking; ?>" class="form-control">
				  </div>
				</div>
              </div>
			  <div class="hr-line-dashed"></div>
...
$(document).ready(function() {
	$('#btn-sync').click(function() {
		...
		if(tracking) {
			$.ajax({
				url: '<?php echo base_url(); ?>store/store_sale_sync_upload/upload_sale_ajax?sale_id=<?php echo $sale_id; ?>',
				dataType: 'json',
				beforeSend: function() {
					$('#btn-sync').html('<i class="fa fa-spinner fa-spin"></i>');
				},
				complete: function() {
					$('#btn-sync').html('<i class="fa fa-refresh"></i>');
				},
				success: function(json) {					
					if(json.success) {
