...
<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-lg-12">
	...
	<ol class="breadcrumb">
	  ...
	  <li class="active"><strong><?php echo $this->lang->line('text_information_edit'); ?></strong></li>
	</ol>
  </div>
...
<div class="wrapper wrapper-content animated fadeInRight">
  <div class="row">
	...
	<form method="post" action="<?php echo base_url(); ?>setting/information/edit?information_id=<?php echo $information_id; ?>" class="form-horizontal">
