...
class Checkout_fba extends MX_Controller 
{
	...
	{	
		...
		$this->load->view('check/checkout_fba_list', $data);
	}
	...
	public function reload()
	{
		...
		$this->load->view('check/checkout_fba_list_table', $data);
	}
	...
	{	
		...
		$this->pagination->url    = base_url().'check/checkout_fba?page={page}'.$url;
		...
		$data['sort_id']         = base_url() . 'check/checkout_fba?sort=id' . $url;
		$data['sort_sale_id']    = base_url() . 'check/checkout_fba?sort=sale_to_checkout.sale_id' . $url;
		$data['sort_tracking']   = base_url() . 'check/checkout_fba?sort=tracking' . $url;
		$data['sort_status']     = base_url() . 'check/checkout_fba?sort=status' . $url;
		$data['sort_date_added'] = base_url() . 'check/checkout_fba?sort=date_added' . $url;
