...
<link href="<?php echo base_url(); ?>assets/css/app/check/checkout_label.css" rel="stylesheet"> 
</head>
<body>
...
$(document).ready(function() {
	...
	data = new FormData();
	data.append('checkout_id', '<?php echo $checkout_id; ?>');
	
	$.ajax({
		url: '<?php echo base_url(); ?>check/checkout_label/check',
		type: 'post',
		data: data,
		dataType: 'json',
		cache: false,
		...
		success: function(json) {			
			...
			{				
				...
				$.ajax({
					url: '<?php echo base_url(); ?>check/checkout_label/execute',
					type: 'post',
					data: data,
					dataType: 'html',
					cache: false,
