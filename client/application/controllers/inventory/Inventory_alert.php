...
class Inventory_alert extends CI_Controller {
	...
	function index()
	{
		...
		$data['limit_10']  = base_url() . 'inventory/inventory_alert?limit=10' . $url;
		$data['limit_15']  = base_url() . 'inventory/inventory_alert?limit=15' . $url;
		$data['limit_50']  = base_url() . 'inventory/inventory_alert?limit=50' . $url;
		$data['limit_100'] = base_url() . 'inventory/inventory_alert?limit=100' . $url;
