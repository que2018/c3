...
class Label extends MX_Controller
{
	...
	{	
		...
		$data['sort_sale_id']  = base_url().'sale/label?sort=sale_label.sale_id' . $url;
		$data['sort_tracking'] = base_url().'sale/label?sort=sale_label.tracking' . $url;
		$data['sort_status']   = base_url().'sale/label?sort=sale_label.status_id' . $url;
