...
class Fba_import extends MX_Controller 
{
	...
	{	
		...
		$this->header->add_style(base_url(). 'assets/css/app/check/fba_import.css');
		...
		$this->header->set_title($this->lang->line('text_import_fba'));	
			
		$data['header'] = Modules::run('module/header/index');
		$data['footer'] = Modules::run('module/footer/index');	
		
		$this->load->view('check/fba_import', $data);
	}
	...
	protected function import_excel($store_id, $file) 
	{
		...
		{ 
			...
			else if($product_info['client_id'] != $store['client_id'])
			{				
