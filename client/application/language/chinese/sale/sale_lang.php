...
$lang['text_label_fee_note1']    	            = '订单#%s的费用 店铺订单号:#%s';
$lang['text_label_fee_note2']    	            = '订单#:%s的费用';
$lang['text_label_fee_additional']    	        = '订单#:%s的额外费用';
$lang['text_sale_transaction_note']    	        = '订单#:%s的交易';
...
$lang['text_import_order_success'] 	  	 		= '<i class="fa fa-check-circle-o"></i>&nbsp;订单导入成功';
$lang['text_checkout_record_is_generated']		= '<i class="fa fa-check-circle-o"></i>&nbsp;出库记录生成';
