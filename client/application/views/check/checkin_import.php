...
<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-lg-12">
	...
	<ol class="breadcrumb">
	  ...
	  <li class="active"><strong><?php echo $this->lang->line('text_import_checkin'); ?></strong></li>
	</ol>
  </div>
	...
	<div class="col-lg-12">
	  <div class="ibox">
	    ...
	    <div class="ibox-content">
		  ...
		  <form action="<?php echo base_url(); ?>/check/checkin_import/upload" class="dropzone" id="dropzoneForm">
			<div class="fallback">
