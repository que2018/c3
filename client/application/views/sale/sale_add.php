...
<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-lg-12">
    ...
    <div class="button-group tooltip-demo">
      ...
      <a href="<?php echo base_url(); ?>sale/sale" data-toggle="tooltip" data-placement="top" title="<?php echo $this->lang->line('text_retu'); ?>" class="btn btn-default btn-return"><i class="fa fa-reply"></i></a>
    </div>	
  </div>
</div>
