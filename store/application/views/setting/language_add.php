<link href="<?php echo base_url(); ?>assets/css/app/setting/language_add.css" rel="stylesheet"> 
<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-lg-12">
	<h2><?php echo $this->lang->line('text_language_add'); ?></h2>
	<ol class="breadcrumb">
	  ...
	  <li class="active"><strong><?php echo $this->lang->line('text_language_add'); ?></strong></li>
	</ol>
	...
	<div class="col-lg-12">
	  ...
	  <div class="ibox">
	    <div class="ibox-content">
		  <form method="post" action="<?php echo base_url(); ?>setting/language/add" class="form-horizontal">
