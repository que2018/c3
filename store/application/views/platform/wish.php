...
<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-lg-12">
	...
	<ol class="breadcrumb">
	  ...
	  <li class="active"><strong><?php echo $this->lang->line("text_wish"); ?></strong></li>
	</ol>
  </div>
		  ...
		  <div class="tab-content">
		    <div id="fields" class="tab-pane active">
			  <div class="panel-body">
			    <?php foreach($wish_fields as $wish_field) { ?>
			      <div class="form-group">
				    <label class="col-sm-2 control-label"><?php echo $this->lang->line('entry_field'); ?></label>
			        <div class="col-sm-10"><input name="wish_field[]" value="<?php echo $wish_field; ?>" class="form-control" readonly></div>
				  </div>
		    ...
		    <div id="setting" class="tab-pane">
			  <div class="panel-body">
			    <div class="form-group">
				  ...
				  <div class="col-sm-10">
				    <select name="wish_status" class="form-control">
					  <?php if($wish_status) { ?>
                ...
                <div class="form-group">
				  ...
				  <div class="col-sm-10"><input name="wish_sort_order" value="<?php echo $wish_sort_order; ?>" class="form-control"></div>	  
			    </div>
				<div class="hr-line-dashed"></div>				
			  </div>
		    </div>
