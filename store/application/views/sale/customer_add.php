...
<link href="<?php echo base_url(); ?>assets/css/app/sale/customer_add.css" rel="stylesheet"> 
<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-lg-12">
	<h2><?php echo $this->lang->line('text_add_customer'); ?></h2>
	<ol class="breadcrumb">
	  <li><a href="<?php echo base_url(); ?>"><?php echo $this->lang->line('text_home'); ?></a></li>
	  <li><a href="<?php echo base_url(); ?>sale/customer"><?php echo $this->lang->line('text_customer'); ?></a></li>
	  <li class="active"><strong><?php echo $this->lang->line('text_add_customer'); ?></strong></li>
	</ol>
  ...
  <div class="row">
	...
	<div class="ibox">
	  <div class="ibox-content">
		<form method="post" action="<?php echo base_url(); ?>sale/customer/add" class="form-horizontal">
