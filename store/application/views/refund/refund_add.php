...
<link href="<?php echo base_url(); ?>assets/css/app/refund/refund_add.css" rel="stylesheet">
<script src="<?php echo base_url(); ?>assets/js/plugins/jquery-ui/jquery-ui.min.js"></script>
<script src="<?php echo base_url(); ?>assets/js/plugins/summernote/summernote.min.js"></script>
<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-lg-12">
	<h2><?php echo $this->lang->line('text_return_add'); ?></h2>
	<ol class="breadcrumb">
	  <li><a href="<?php echo base_url(); ?>"><?php echo $this->lang->line('text_home'); ?></a></li>
	  <li><a href="<?php echo base_url(); ?>refund/refund"><?php echo $this->lang->line('text_return'); ?></a></li>
	  <li class="active"><strong><?php echo $this->lang->line('text_return_add'); ?></strong></li>
	</ol>
  </div>
  <div class="button-group tooltip-demo">
    ...
    <a href="<?php echo base_url(); ?>refund/refund" data-toggle="tooltip" data-placement="top" title="<?php echo $this->lang->line('text_cancel'); ?>" class="btn btn-default btn-refund"><i class="fa fa-reply"></i></a>
  </div>	
</div>
