...
<link href="<?php echo base_url(); ?>assets/css/app/inventory/transfer_edit.css" rel="stylesheet">
<script src="<?php echo base_url(); ?>assets/js/plugins/jquery-ui/jquery-ui.min.js"></script>
<script src="<?php echo base_url(); ?>assets/js/plugins/summernote/summernote.min.js"></script>
<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-lg-12">
	<h2><?php echo $this->lang->line('text_transfer_edit'); ?></h2>
	<ol class="breadcrumb">
	  <li><a href="<?php echo base_url(); ?>"><?php echo $this->lang->line('text_home'); ?></a></li>
	  <li><a href="<?php echo base_url(); ?>inventory/transfer"><?php echo $this->lang->line('text_transfer'); ?></a></li>
	  <li class="active"><strong><?php echo $this->lang->line('text_transfer_edit'); ?></strong></li>
	</ol>
  </div>
				  ...
				  <table id="transfer-product" class="table table-bordered">
				    ...
				    <tbody>
					  ...
					  <?php if($transfer_products) { ?>
						...
						<td class="text-left"><input name="transfer_product[<?php echo $transfer_product_row; ?>][product_id]" type="hidden" value="<?php echo $transfer_product['product_id']; ?>"><div class="text-left"><?php echo $transfer_product['name']; ?></div></td>
