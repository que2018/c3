		    ...
		    <div class="row">
			  ...
			  <div class="col-md-3">
			    <div class="form-group">
			      ...
			      <div class="col-sm-9"><input name="location" class="form-control" value="<?php echo $filter_location; ?>"></div>
			    </div>
			  </div>
			  <div class="col-md-3">
			    <div class="form-group">
					...
					<tr>
					  ...
					  <td class="text-center">
					    <a href="<?php echo base_url(); ?>inventory/inventory/edit?inventory_id=<?php echo $inventory['inventory_id']; ?>" class="btn btn-primary"><i class="fa fa-pencil-square-o"></i></a>
					  	<button class="btn btn-danger btn-delete" data="<?php echo $inventory['inventory_id']; ?>"><i class="fa fa-trash"></i></button>
					  </td>				
					</tr>
					<?php $offset++; ?>
				  <?php } ?>
